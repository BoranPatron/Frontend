...
import TendersSidebar from '../components/TendersSidebar';
import { 
...
export default function ServiceProviderDashboard() {
  ...
  return (
    <>
      ...
      {/* Angebotsverfahren und Gewonnene Projekte - Full Width */}
      <div className="mb-8">
        <div className="space-y-6" data-tour-id="offer-management-section">
      ...
      <TendersSidebar
        ...
        serviceProviderQuotes={serviceProviderQuotes}
        onTradeClick={handleTradeDetails}
        onCreateQuote={handleCreateQuote}
        hasServiceProviderQuote={hasServiceProviderQuote}
        getServiceProviderQuoteStatus={getServiceProviderQuoteStatus}
        getServiceProviderQuote={getServiceProviderQuote}
        isLoading={geoLoading || isLoadingTrades}
        error={geoError || tradesError}
        isGeocoding={isGeocoding}
        handleSelectedAddressGeocode={handleSelectedAddressGeocode}
        useOwnLocation={useOwnLocation}
        performGeoSearch={performGeoSearch}
        selectedAddress={selectedAddress}
        setSelectedAddress={setSelectedAddress}
        geoTradeCategory={geoTradeCategory}
        setGeoTradeCategory={setGeoTradeCategory}
        getCategoryIcon={getCategoryIcon}
        formatCurrency={formatCurrency}
        formatDate={formatDate}
        getCompletionStatusLabel={getCompletionStatusLabel}
