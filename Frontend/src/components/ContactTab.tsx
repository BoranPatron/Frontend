...
export default function ContactTab({ userRole, userId }: ContactTabProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('openContactTab', open as EventListener);
    return () => window.removeEventListener('openContactTab', open as EventListener);
  }, []);
    ...
    <>
      ...
      <div ref={contactTabRef} className="fixed right-0 z-[9997]">
        ...
        <button
          ...
          className={`fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 sm:bottom-[160px] sm:right-[20px] sm:left-auto sm:top-auto z-[9997] lg:hidden 
