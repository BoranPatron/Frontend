// Debug-Skript für Kostenvoranschlag-Button Problem
// Führe dies in der Browser-Konsole aus

console.log('🔍 Debug: Kostenvoranschlag-Button Problem - Dienstleister-Ansicht');
...
function testButtonClick() {
  ...
  if (costEstimateButtons.length > 0) {
    console.log('🔘 Teste Klick auf ersten Button...');
...
// Umfassender Test
function runCostEstimateButtonDebug() {
  console.log('🚀 Starte umfassenden Kostenvoranschlag-Button-Debug...');
  ...
  // Teste Button-Click
  console.log('🔘 Teste Button-Click...');
  const clickResult = testButtonClick();
  
  return {
    ...results,
    buttonClickTest: clickResult
  };
}
...
console.log('- testButtonClick() - Teste Button-Click');
console.log('- runCostEstimateButtonDebug() - Umfassender Test');

// Führe automatischen Test aus
runCostEstimateButtonDebug(); 